...
{{render:vrdr/vrdrdeathpronouncementperformer-duplicate-2}}</center>

---

### **Structure Definition**

{{profile:vrdr/vrdrdeathpronouncementperformer, expand}}
...
{{table:vrdr/vrdrdeathpronouncementperformer, expand}}
