...
{{render:vrdr/vrdrtobaccousecontributedtodeath-duplicate-2}}</center>

---

### **Structure Definition**

{{profile:vrdr/vrdrtobaccousecontributedtodeath, expand}}
...
{{table:vrdr/vrdrtobaccousecontributedtodeath, expand}}
