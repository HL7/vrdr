...
{{render:vrdr/vrdrdeathcertificatedocument-duplicate-2}}</center>

---

### **Structure Definition**

{{profile:vrdr/vrdrdeathcertificatedocument, expand}}
...
{{table:vrdr/vrdrdeathcertificatedocument, expand}}
