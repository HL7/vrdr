...
{{render:vrdr/vrdrdecedentemploymenthistory-duplicate-2}}</center>

---

### **Structure Definition**

{{profile:vrdr/vrdrdecedentemploymenthistory, expand}}
...
{{table:vrdr/vrdrdecedentemploymenthistory, expand}}
