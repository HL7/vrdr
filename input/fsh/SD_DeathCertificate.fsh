...
* insert BundleSectionSlice(DeathCertification, ConditionContributingToDeath,  0, 1, ConditionContributingToDeath, ConditionContributingToDeath, DecedentTransportationRole)
