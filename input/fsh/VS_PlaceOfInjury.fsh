...
Description: "Place of Injury from NCHS TRX Format.  This contains all of the codes from [https://loinc.org/LL1051-3/](https://loinc.org/LL1051-3/) except for LA14087-3 (Public Institution).
