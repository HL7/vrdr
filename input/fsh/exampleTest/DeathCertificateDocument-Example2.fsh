...
* identifier
  ...
  * value = "2020NY000182"
* entry[0]
  * resource = DeathCertificate-Example2
  * fullUrl = "http://www.example.org/fhir/Bundle/DeathCertificate-Example2"
* entry[+]
...
* entry[+]
  * resource = InjuryIncident-Example2
