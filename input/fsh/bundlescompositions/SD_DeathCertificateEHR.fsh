Profile: DeathCertificateEHR
Parent: Composition
Id: vrdr-death-certificate-EHR
Title: "Death Certificate EHR"
Description: "The body of the death certificate document (Composition) from EHR to EDRS."
