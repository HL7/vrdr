...
Title: "Part 2 Other Significant Conditions Contributing to Death"
Description: "This profile as asserted by the death certifier, captures other significant conditions contributing to death but not resulting in the underlying cause given in Part 1."
//* insert RequireMetaProfile(CauseOfDeathPart2)
* code only CodeableConcept
* code = $loinc#69441-4 
  * ^short = "Other significant conditions contributing to death"
* value[x] 1..1
* value[x] only CodeableConcept
* valueCodeableConcept
  * text 1..1
  * text ^short = "Other significant conditions contributing to death"
  * text ^maxLength = 240
* subject 1..1
