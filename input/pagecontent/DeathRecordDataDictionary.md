...
| 232 | State, U.S. Territory or Canadian Province of Certifier - code | CERTSTATECD| [Certifier]| x|address.state | string | [ValueSetStatesTerritoriesAndProvincesVitalRecords] | 
...
| 239 | Country of Death - Code | DTHCOUNTRYCD| [DeathLocation]| x|address.country  | string  | [ValueSetResidenceCountryVitalRecords].  Note: For US Death certificates should be US | 
...
| 22 | Birthplace--Country | BPLACE_CNT| [Decedent]| |extension[patient-birthPlace].value[x].country  | string | [ExtensionRelatedpersonBirthplaceVitalRecords] | 
...
| 29 | Marital Status | MARITAL| [Decedent]| |maritalStatus | codeable |  [ValueSetMaritalStatusVitalRecords] | 
...
| 16 | Decedent's Age--Type | AGETYPE| [DecedentAge]| |valueQuantity.code | codeable | [ValueSetUnitsOfAgeVitalRecords] | 
...
| 38 | Decedent's Education--Edit Flag | DEDUC_BYPASS| [DecedentEducationLevel]| |value.extension[ByPassEdit].value | codeable | [ValueSetEditBypass01234VitalRecords] | 
...
| 128 | Decedent ever served in Armed Forces? | ARMEDF| [DecedentMilitaryService]| x|value | codeable | [ValueSetYesNoUnknownVitalRecords] | 
...
| 112 | Pregnancy | PREG| [DecedentPregnancyStatus]| |value | codeable | [DeathPregnancyStatusVS] | 
...
| 84 | Occupation -- Literal  | OCCUP| [ObservationUsualWorkVitalRecords]| |value.text | string(40) | - | 
| 86 | Industry -- Literal  | INDUST| [ObservationUsualWorkVitalRecords]| |component [ odh-UsualIndustry	].value.text | string(40) | - | 
| 94 | Occupation -- 4 digit Code  | OCCUPC4| [ObservationUsualWorkVitalRecords]| |valueCodeableConcept.coding[occupationCDCCensus2018]  | codeable | [PHVS_Occupation_CDC_Census2018VS] | 
| 95 | Industry -- 4 digit Code | INDUSTC4| [ObservationUsualWorkVitalRecords]| |component[odh-UsualIndustry].valueCodeableConcept.coding[industryCDCCensus2018]  | codeable | [PHVS_Industry_CDC_Census2018VS] | 
| 202 | State, U.S. Territory or Canadian Province of Disposition - code | DISPSTATECD| [DispositionLocation]| x|address.state | string | [ValueSetStatesTerritoriesAndProvincesVitalRecords] | 
...
| 172 | Was case Referred to Medical Examiner/Coroner? | REFERRED| [ExaminerContacted]| x|value | codeable | [ValueSetYesNoUnknownVitalRecords] | 
...
| 215 | State, U.S. Territory or Canadian Province of Funeral Facility - code | FUNSTATECD| [FuneralHome]| x|address.state | string | [ValueSetStatesTerritoriesAndProvincesVitalRecords] | 
...
| 180 | State, U.S. Territory or Canadian Province of Injury - code | STATECODE_I| [InjuryLocation]| x|address.state | string | [ValueSetStatesTerritoriesAndProvincesVitalRecords] | 
...
| 39 | Decedent of Hispanic Origin?--Mexican | DETHNIC1| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ HispanicMexican].valueCoding | codeable | [ValueSetHispanicNoUnknownVitalRecords] | 
| 40 | Decedent of Hispanic Origin?--Puerto Rican | DETHNIC2| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ HispanicPuertoRican].valueCoding | codeable | [ValueSetHispanicNoUnknownVitalRecords] | 
| 41 | Decedent of Hispanic Origin?--Cuban | DETHNIC3| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ HispanicCuban ].valueCoding | codeable | [ValueSetHispanicNoUnknownVitalRecords] | 
| 42 | Decedent of Hispanic Origin?--Other | DETHNIC4| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ HispanicOther ].valueCoding | codeable | [ValueSetHispanicNoUnknownVitalRecords] | 
| 43 | Decedent of Hispanic Origin?--Other, Literal | DETHNIC5| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ HispanicLiteral ].valueString | string | - | 
| 44 | Decedent's Race--White | RACE1| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ White].valueBoolean | boolean | - | 
| 45 | Decedent's Race--Black or African American | RACE2| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ BlackOrAfricanAmerican].valueBoolean | boolean | - | 
| 46 | Decedent's Race--American Indian or Alaska Native | RACE3| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ AmericanIndianOrAlaskanNative].valueBoolean | boolean | - | 
| 47 | Decedent's Race--Asian Indian | RACE4| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ AsianIndian].valueBoolean | boolean | - | 
| 48 | Decedent's Race--Chinese | RACE5| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ Chinese].valueBoolean | boolean | - | 
| 49 | Decedent's Race--Filipino | RACE6| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ Filipino].valueBoolean | boolean | - | 
| 50 | Decedent's Race--Japanese | RACE7| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ Japanese].valueBoolean | boolean | - | 
| 51 | Decedent's Race--Korean | RACE8| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ Korean].valueBoolean | boolean | - | 
| 52 | Decedent's Race--Vietnamese | RACE9| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ Vietnamese].valueBoolean | boolean | - | 
| 53 | Decedent's Race--Other Asian | RACE10| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ OtherAsian].valueBoolean | boolean | - | 
| 54 | Decedent's Race--Native Hawaiian | RACE11| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ NativeHawaiian].valueBoolean | boolean | - | 
| 55 | Decedent's Race--Guamanian or Chamorro | RACE12| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ GuamanianOrChamorro].valueBoolean | boolean | - | 
| 56 | Decedent's Race--Samoan | RACE13| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ Samoan].valueBoolean | boolean | - | 
| 57 | Decedent's Race--Other Pacific Islander | RACE14| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ OtherPacificIslander].valueBoolean | boolean | - | 
| 58 | Decedent's Race--Other | RACE15| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ OtherRace].valueBoolean | boolean | - | 
| 59 | Decedent's Race--First American Indian or Alaska Native Literal | RACE16| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ FirstAmericanIndianOrAlaskanNativeLiteral].valueString | string | - | 
| 60 | Decedent's Race--Second American Indian or Alaska Native Literal | RACE17| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ SecondAmericanIndianOrAlaskanNativeLiteral].valueString | string | - | 
| 61 | Decedent's Race--First Other Asian Literal | RACE18| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ FirstOtherAsianLiteral].valueString | string | - | 
| 62 | Decedent's Race--Second Other Asian Literal | RACE19| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ SecondOtherAsianLiteral].valueString | string | - | 
| 63 | Decedent's Race--First Other Pacific Islander Literal | RACE20| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ FirstOtherPacificIslanderLiteral].valueString | string | - | 
| 64 | Decedent's Race--Second Other Pacific Islander Literal | RACE21| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ SecondOtherPacificIslanderLiteral].valueString | string | - | 
| 65 | Decedent's Race--First Other Literal | RACE22| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ FirstOtherRaceLiteral].valueString | string | - | 
| 66 | Decedent's Race--Second Other Literal | RACE23| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ SecondOtherRaceLiteral].valueString | string | - | 
| 83 | Decedent's Race--Missing | RACE_MVR| [ObservationInputRaceAndEthnicityVitalRecords]| |component[ MissingValueReason].valueCoding | codeable | [ValueSetRaceMissingValueReasonVitalRecords]  | 
...
| 67 | First Edited Code | RACE1E| [ObservationCodedRaceAndEthnicityVitalRecords]| |component[FirstEditedCode].value | - |  | 
| 68 | Second Edited Code | RACE2E| [ObservationCodedRaceAndEthnicityVitalRecords]| |component[SecondEditedCode].value | codeable | [ValueSetRaceCodeVitalRecords] | 
| 69 | Third Edited Code | RACE3E| [ObservationCodedRaceAndEthnicityVitalRecords]| |component[ThirdEditedCode].value | codeable | [ValueSetRaceCodeVitalRecords] | 
| 70 | Fourth Edited Code | RACE4E| [ObservationCodedRaceAndEthnicityVitalRecords]| |component[FourthEditedCode].value | codeable | [ValueSetRaceCodeVitalRecords] | 
| 71 | Fifth Edited Code | RACE5E| [ObservationCodedRaceAndEthnicityVitalRecords]| |component[FifthEditedCode].value | codeable | [ValueSetRaceCodeVitalRecords] | 
| 72 | Sixth Edited Code | RACE6E| [ObservationCodedRaceAndEthnicityVitalRecords]| |component[SixthEditedCode].value | codeable | [ValueSetRaceCodeVitalRecords] | 
| 73 | Seventh Edited Code | RACE7E| [ObservationCodedRaceAndEthnicityVitalRecords]| |component[SeventhEditedCode].value | codeable | [ValueSetRaceCodeVitalRecords] | 
| 74 | Eighth Edited Code | RACE8E| [ObservationCodedRaceAndEthnicityVitalRecords]| |component[EighthEditedCode].value | codeable | [ValueSetRaceCodeVitalRecords] | 
| 75 | First American Indian Code | RACE16C| [ObservationCodedRaceAndEthnicityVitalRecords]| |component[FirstAmericanIndianCode].value | codeable | [ValueSetRaceCodeVitalRecords] | 
| 76 | Second American Indian Code | RACE17C| [ObservationCodedRaceAndEthnicityVitalRecords]| |component[SecondAmericanIndianCode].value | codeable | [ValueSetRaceCodeVitalRecords] | 
| 77 | First Other Asian Code | RACE18C| [ObservationCodedRaceAndEthnicityVitalRecords]| |component[FirstOtherAsianCode].value | codeable | [ValueSetRaceCodeVitalRecords] | 
| 78 | Second Other Asian Code | RACE19C| [ObservationCodedRaceAndEthnicityVitalRecords]| |component[SecondOtherAsianCode].value | codeable | [ValueSetRaceCodeVitalRecords] | 
| 79 | First Other Pacific Islander Code | RACE20C| [ObservationCodedRaceAndEthnicityVitalRecords]| |component[FirstOtherPacificIslanderCode].value | codeable | [ValueSetRaceCodeVitalRecords] | 
| 80 | Second Other Pacific Islander Code | RACE21C| [ObservationCodedRaceAndEthnicityVitalRecords]| |component[SecondOtherPacificIslanderCode].value | codeable | [ValueSetRaceCodeVitalRecords] | 
| 81 | First Other Race Code | RACE22C| [ObservationCodedRaceAndEthnicityVitalRecords]| |component[FirstOtherRaceCode].value | codeable | [ValueSetRaceCodeVitalRecords] | 
| 82 | Second Other Race Code | RACE23C| [ObservationCodedRaceAndEthnicityVitalRecords]| |component[SecondOtherRaceCode].value | codeable | [ValueSetRaceCodeVitalRecords] | 
| NA | Race Recode 40  (No longer provided as of 2022) | *NO IJE MAPPING*| [ObservationCodedRaceAndEthnicityVitalRecords]| |component[RaceRecode40].value | codeable | [ValueSetRaceCodeVitalRecords] | 
| 160 | Hispanic | DETHNICE | [ObservationCodedRaceAndEthnicityVitalRecords]| |component[HispanicCode].value | codeable | [ValueSetHispanicOriginVitalRecords] | 
| 247 | Hispanic Code for Literal | DETHNIC5C| [ObservationCodedRaceAndEthnicityVitalRecords]| |component[HispanicCodeForLiteral].value | codeable | [ValueSetHispanicOriginVitalRecords] | 
