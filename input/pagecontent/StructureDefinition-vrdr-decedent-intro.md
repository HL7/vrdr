...
| :---------: | ------------- | ------------ | :----------: |---------- | -------- | -------- |
| 7 | Decedent's Legal Name--Given  | GNAME| |name.given , name.use = official | string | y | 
| 8 | Decedent's Legal Name--Middle | MNAME| |name.given , name.use = official (first letter) | string | y | 
| 9 | Decedent's Legal Name--Last | LNAME| |name.family , name.use = official | string | y | 
| 10 | Decedent's Legal Name--Suffix | SUFF| |name.suffix , name.use = official | string | y | 
| 13 | Sex | SEX| |extension[NVSS-SexAtDeath]  | codeable | [AdministrativeGenderVS] | 
| 15 | Social Security Number | SSN| |identifier.value where system = 'http://hl7.org/fhir/sid/us-ssn and type.coding.code="SB" | string | y | 
...
| 146 | Decedent's Residence - Street number | STNUM_R| |address.extension[stnum] | string | y | 
| 147 | Decedent's Residence - Pre Directional | PREDIR_R| |address.extension[predir] | string | y | 
| 148 | Decedent's Residence - Street name | STNAME_R| |address.extension[stname] | string | y | 
| 149 | Decedent's Residence - Street designator | STDESIG_R| |address.extension[stdesig] | string | y | 
| 150 | Decedent's Residence - Post Directional | POSTDIR_R| |address.extension[postdir] | string | y | 
| 151 | Decedent's Residence - Unit or apt number | UNITNUM_R| |address.extension[unitnum] | string | y | 
| 152 | Decedent's Residence - City or Town name | CITYTEXT_R| |address.city | string | y | 
| 153 | Decedent's Residence - ZIP code | ZIP9_R| |address.postalCode | string | y | 
| 154 | Decedent's Residence - County | COUNTYTEXT_R| |address.district | string | y | 
| 155 | Decedent's Residence - State name | STATETEXT_R | |address.state (expanded from 2 letter code) | string | y | 
| 156 | Decedent's Residence - COUNTRY name | COUNTRYTEXT_R| |address.country (expanded from 2 letter code) | string | y | 
| 157 | Long string address for decedent's place of residence same as above but allows states to choose the way they capture information. | ADDRESS_R| |address.line[0] | string | y | 
...
| 238 | State, U.S. Territory or Canadian Province of Birth - literal | STATEBTH| x|extension[patient-birthPlace].value[x].state or extension[patient-birthPlace].value[x].state.extension[ nationalReportingJurisdictionId] if present    (expanded from 2 letter code) | string |  | 
