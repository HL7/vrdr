...
Coded industry and occupation can be transmitted using a [Coded Industry and Occupation Bundle][IndustryOccupationCodedContentBundle] containing a single VRDR [Decedent Usual Work][DecedentUsualWork] instance.  This bundle is information-content equivalent to the tranditional MIO files.
