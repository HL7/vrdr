...
Usage: #example
* type = #document
* identifier.extension.url = "http://hl7.org/fhir/us/vrdr/StructureDefinition/AuxiliaryStateIdentifier"
* identifier.extension.valueString = "009182"
...
* entry[+].resource = ParametersForEmergingIssues-Example1
* entry[=].fullUrl = "http://www.example.org/fhir/Parameters/ParametersForEmergingIssues-Example1"
...
* entry[+].resource = DecedentTransportationRole-Example1
* entry[=].fullUrl = "http://www.example.org/fhir/Observation/DecedentTransportationRole-Example1"
