...
an identifier. The VRDR IG profiles require a [VitalRecordsPractitioner] instance for references to the Certifier.  This is to ensure that these profiles are not over-constrained for use by the MDI IG
